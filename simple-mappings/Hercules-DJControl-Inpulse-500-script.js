...
DJCi500.filterKnob1 = function (channel, control, value, status, group) {
    ...
    if (fx_active && deck_sel) {
        ...
        // engine.setValue("[EffectRack1_EffectUnit1]", "super1", Math.abs(script.absoluteNonLin(value, 0.0, 0.5, 1.0, 0, 127) - 0.5)*2 ); // pikujs removed
    ...
    engine.setValue("[EffectRack1_EffectUnit1]", "super1", Math.abs(script.absoluteNonLin(value, 0.0, 0.5, 1.0, 0, 127) - 0.5)*2 ); // pikujs added
};
DJCi500.filterKnob2 = function (channel, control, value, status, group) {
    ...
    if (fx_active && deck_sel) {
        ...
        // engine.setValue("[EffectRack1_EffectUnit2]", "super1", Math.abs(script.absoluteNonLin(value, 0.0, 0.5, 1.0, 0, 127) - 0.5)*2 ); // pikujs removed
    ...
    engine.setValue("[EffectRack1_EffectUnit2]", "super1", Math.abs(script.absoluteNonLin(value, 0.0, 0.5, 1.0, 0, 127) - 0.5)*2 ); // pikujs added
};
